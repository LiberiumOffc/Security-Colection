...
-- 3. СОЗДАНИЕ ДАТЧИКА (Лицевой купол)
tool.Activated:Connect(function()
    ...
    body.CFrame = CFrame.new(pos + Vector3.new(0, 1, 0), Player.Character.Head.Position)
    ...
    table.insert(sensors, {model = model, body = body, active = true})
end)
